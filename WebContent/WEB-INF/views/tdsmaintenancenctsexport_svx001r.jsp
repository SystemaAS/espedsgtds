...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tdsmaintenancenctsexport_svx001r.js?ver=${user.versionEspedsg}"></SCRIPT>	
		...
		<table width="100%" class="text11" cellspacing="0" border="0" cellpadding="0">
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a id="alinkSadMaintExportKoder" tabindex=-1 style="display:block;" href="tdsmaintenancenctsexport_kodergate.do?id=SVXKODF">
		...
		<%-- space separator --%>
			...
			<tr >
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="tdsmaintenancenctsexport_svx001r_edit.do" name="formRecord" id="formRecord" method="POST" >
