...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/nctsexport_edit_items_childwindow_uppdragslist.js?ver=${user.versionEspedsg}"></SCRIPT>
	...
	<table width="90%" height="500px" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		...
		<td valign="top">
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						<table>
						<form name="nctsExportAngivelseForm" id="nctsExportAngivelseForm" action="nctsexport_edit_items_childwindow_uppdragslist.do?action=doFind" method="post">
					...
					<table id="uppdragsList" class="display compact cell-border" width="100%" >
						<thead>
