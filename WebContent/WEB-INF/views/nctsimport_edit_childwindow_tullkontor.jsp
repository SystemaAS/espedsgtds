...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/nctsimport_edit_childwindow_tullkontor.js?ver=${user.versionEspedsg}"></SCRIPT>
	...
	<table width="90%" height="500px" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		...
		<td valign="top">
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						<table>
						<form name="tullkontorForm" id="tullkontorForm" action="nctsimport_edit_childwindow_tullkontor.do?action=doInit" method="post">
						...
						<tr>
							...
							<td class="text14">&nbsp;</td>
	           				<td align="right">&nbsp;<input class="inputFormSubmit" type="submit" name="submit" value='<spring:message code="systema.tds.search"/>'>
		           		</tr>
					...
					<table id="tullkontorList" class="display compact cell-border" width="100%" >
						...
						<tr class="tableHeaderField">
		                    ...
		                    <th class="text14" title="adembg">&nbsp;Tullkontor&nbsp;</th>
