					               ...
					               <tbody>
				 					  <c:forEach items="${model.list}" var="record" varStatus="counter">    
							               ...
							               <td align="center" width="2%" class="text14" >
							               		<a style="display:block;" tabindex=-1 id="recordUpdate_${record.svif_fatx}_${record.svif_faty}" href="#" onClick="getItemData(this);">
							               			&nbsp;<img src="resources/images/update.gif" border="0" alt="edit">&nbsp;
							               		</a>
							               </td>
						...
						<tr>
							<td class="text14Bold">
								<c:if test="${model.status == 'M' || empty model.status}">
									...
									&nbsp;&nbsp;<img title="Ladda upp faktura (.csv)" style="vertical-align: bottom;cursor: pointer;" id="uploadFileImg" width="25px" height="25px" src="resources/images/upload.png" border="0" alt="Upload dokument (.csv)">
								</c:if>
							</td>
						</tr>
				   </table>
