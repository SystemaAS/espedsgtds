...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tdsadmin_norskexport.js?ver=${user.versionEspedsg}"></SCRIPT>	
	...
	<table width="100%"  class="text11" cellspacing="0" border="0" cellpadding="0">
		...
		<tr height="25"> 
			...
			<td width="20%" valign="bottom" class="tab" align="center" nowrap>
        			<font class="tabLink">&nbsp;<spring:message code="systema.tds.admin.norsk.export.list.tab"/></font>
				<img valign="bottom" src="resources/images/list.gif" border="0" alt="general list">
			</td>
			...
			<tr>
				...
				<table width="100%" cellspacing="0" border="0" cellpadding="0">
					<tr class="tableHeaderField" height="20" valign="left">
	                    <td class="tableHeaderFieldFirst" align="left" >&nbsp;<spring:message code="systema.tds.admin.sadexport.list.search.label.avd"/></td>
                			<td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.tds.admin.sadexport.list.search.label.sign"/></td>
		                <td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.tds.admin.sadexport.list.search.label.transportuppdrag"/></td>
		                <td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.tds.admin.sadexport.list.search.label.sender"/></td>
		                <td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.tds.admin.sadexport.list.search.label.receiver"/></td>
		                <td class="tableHeaderField" align="left" >&nbsp;<spring:message code="systema.tds.admin.sadexport.list.search.label.datum"/></td>
	                </tr>     
