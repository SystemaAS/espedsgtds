...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/nctsexport_edit_childwindow_tullkontor.js?ver=${user.versionEspedsg}"></SCRIPT>
	...
	<table width="90%" height="500px" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		...
		<td valign="top">
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						<table>
						<form name="tullkontorForm" id="tullkontorForm" action="nctsexport_edit_childwindow_tullkontor.do?action=doInit" method="post">
