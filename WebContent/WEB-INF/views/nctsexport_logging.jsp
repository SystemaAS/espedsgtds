			...
			<tr>
				...
				<table width="100%" cellspacing="0" border="0" cellpadding="0">
					...
					<tr class="tableHeaderField" height="20" valign="left">
	                    ...
	                    <th class="tableHeaderFieldFirst">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.topicNr"/>&nbsp;</th>
	                    <th class="tableHeaderField">&nbsp;Interch.nr&nbsp;</th>
						<th class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.messageNr"/>&nbsp;</th> 
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.type"/>&nbsp;</th> 
	                      
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.date"/>&nbsp;</th>
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.time"/>&nbsp;</th>
	                    <th class="tableHeaderField">&nbsp;Sent/Rec&nbsp;</th>
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.ncts.export.logging.list.label.text"/>&nbsp;</th>
	               </tr> 
	               </thead>  
	               <tbody>  
		               ...
		               <td class="tableCell" >&nbsp;
		               		<a <c:if test="${record.msr == 'R'}">style="color:#9F6000;"</c:if> href="ncts_export_renderEdifact.do?fp=${record.wurl}" target="_new" >
