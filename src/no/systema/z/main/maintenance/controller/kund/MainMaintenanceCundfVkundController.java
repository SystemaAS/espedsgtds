...
import no.systema.z.main.maintenance.model.JsonMaintMainKodtlikRecord;
import no.systema.z.main.maintenance.model.JsonMaintMainKodtotyContainer;
import no.systema.z.main.maintenance.model.JsonMaintMainKodtotyRecord;
import no.systema.z.main.maintenance.model.JsonMaintMainValufContainer;
import no.systema.z.main.maintenance.model.JsonMaintMainValufRecord;
	...
	public ModelAndView getCodes(HttpSession session, HttpServletRequest request){
		...
		if (appUser == null) {
			...
			if ("fmot".equals(caller)) { // Reuse of mainmaintenance_childwindow_customer.jsp
				...
				successViewCustomer.addObject(TdsConstants.DOMAIN_MODEL, model);
