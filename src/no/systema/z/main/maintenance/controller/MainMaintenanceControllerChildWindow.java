...
import no.systema.z.main.maintenance.model.JsonMaintMainKodtot2Record;
...
public class MainMaintenanceControllerChildWindow {
	...
	private String getRequestUrlKeyParametersForSearchCustomer(String applicationUser, String customerName, String customerNumber, String firma){
		  ...
		  if(customerName!=null && !"".equals(customerName) && customerNumber!=null && !"".equals(customerNumber)){
			  sb.append( TdsMaintenanceConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + "knavn=" + customerName );
			  sb.append( TdsMaintenanceConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + "kundnr=" + customerNumber );
			  if(firma!=null && !"".equals(firma)){
				  sb.append( TdsMaintenanceConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + "firma=" + firma );
			  }
	...
	private String getRequestUrlKeyParametersForSearchEdi(String applicationUser, String id, String name){
		  ...
		  if(id!=null && !"".equals(id) && name!=null && !"".equals(name)){
			  sb.append( TdsMaintenanceConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + "inid=" + id );
			  sb.append( TdsMaintenanceConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + "inna=" + name );
	...
	private String getRequestUrlKeyParametersForSearchOpptype(String applicationUser, String id){
		  ...
		  if(id!=null && !"".equals(id) ){
			  sb.append( TdsMaintenanceConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + "ko2kod=" + id.toUpperCase() );
		  }
