 ...
 *
 */
public class JsonNctsExportSpecificTopicRecord extends JsonAbstractGrandFatherRecord {
	private static final Logger logger = Logger.getLogger(JsonNctsExportSpecificTopicRecord.class.getName());
