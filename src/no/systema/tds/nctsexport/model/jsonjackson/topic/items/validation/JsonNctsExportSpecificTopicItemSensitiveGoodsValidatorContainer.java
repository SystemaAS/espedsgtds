 ...
 * 
 */
package no.systema.tds.nctsexport.model.jsonjackson.topic.items.validation;

/**
 * @author oscardelatorre
 * @date Nov 26, 2013
 */
public class JsonNctsExportSpecificTopicItemSensitiveGoodsValidatorContainer {
