 ...
 * 
 */
package no.systema.tds.nctsexport.filter;
 ...
 * @date 	May 17, 2013
 */
public class SearchFilterNctsExportTopicList {
	private static final Logger logger = Logger.getLogger(SearchFilterNctsExportTopicList.class.getName());
