 ...
 *
 */
public class TdsImportListValidator implements Validator {

	/**
	 * 
	 */
	public boolean supports(Class clazz) {
		return SearchFilterTdsImportTopicList.class.isAssignableFrom(clazz); 
	}
	...
	public void validate(Object obj, Errors errors) { 
		SearchFilterTdsImportTopicList record = (SearchFilterTdsImportTopicList)obj;
