...
@Controller
public class TdsExportMainListViewController {
	private static final Logger logger = Logger.getLogger(TdsExportMainListViewController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="tdsExportMainListExcelView.do", method={RequestMethod.GET})
	public ModelAndView getItemListExcelView(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		...
		final String EXCEL_VIEW = "tdsExportMainListExcelView";
