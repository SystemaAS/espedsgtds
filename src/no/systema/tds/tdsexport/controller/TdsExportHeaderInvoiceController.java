...
public class TdsExportHeaderInvoiceController {
			...
			if(TdsConstants.ACTION_UPDATE.equals(action)){
				...
				if(bindingResult.hasErrors()){
					...
					if(isValidCreatedRecordTransactionOnRPG){
						...
						urlRequestParamsKeys = this.getRequestUrlKeyParametersUpdate(jsonTdsExportTopicInvoiceRecord.getSvef_fatx(), jsonTdsExportTopicInvoiceRecord.getSvef_faty(), avd, opd, appUser, TdsConstants.MODE_UPDATE);
	...
	private JsonTdsExportTopicInvoiceRecord createNewItemKeySeeds(JsonTdsExportTopicInvoiceRecord record, String avd, String opd, HttpSession session, HttpServletRequest request, SystemaWebUser appUser){
		...
		urlRequestParamsForSeed.append(TdsConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + "typ=" + record.getSvef_faty());
