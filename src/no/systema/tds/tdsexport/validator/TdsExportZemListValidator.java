 ...
 *
 */
public class TdsExportZemListValidator implements Validator {

	/**
	 * 
	 */
	public boolean supports(Class clazz) {
		return SearchFilterTdsExportTopicZemList.class.isAssignableFrom(clazz); 
	}
	...
	public void validate(Object obj, Errors errors) { 
		SearchFilterTdsExportTopicZemList record = (SearchFilterTdsExportTopicZemList)obj;
