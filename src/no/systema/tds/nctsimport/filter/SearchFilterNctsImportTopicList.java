 ...
 * 
 */
package no.systema.tds.nctsimport.filter;
 ...
 * @date 	Dec 3, 2013
 */
public class SearchFilterNctsImportTopicList {
	private static final Logger logger = Logger.getLogger(SearchFilterNctsImportTopicList.class.getName());
