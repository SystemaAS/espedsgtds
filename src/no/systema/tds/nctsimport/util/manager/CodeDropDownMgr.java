 ...
 * 
 */
package no.systema.tds.nctsimport.util.manager;
...
import no.systema.tds.nctsimport.util.NctsImportConstants;
		...
		try{
			...
			*/
			...
			if(CodeDropDownMgr.CODE_GCY_COUNTRY.equalsIgnoreCase(paramTYP)){
				...
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_GCY_COUNTRY_LIST,list);
				model.put(NctsImportConstants.URL_EXTERNAL_LANDCODES_TARIC_CODE, new UrlTaricCountryObject() );
			
			}else if(CodeDropDownMgr.CODE_MDX_CURRENCY.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_MDX_CURRENCY_LIST,list);
				model.put(NctsImportConstants.URL_EXTERNAL_CURRENCYCODES_TARIC_CODE, new UrlTaricCurrencyObject() );
			
			}else if(CodeDropDownMgr.CODE_012_SPRAK.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_012_SPRAK_LIST, list);
				model.put(NctsImportConstants.URL_EXTERNAL_LANGUAGECODES_ISO_CODE, new UrlISOLanguageObject() );
			
			}else if(CodeDropDownMgr.CODE_013_DOKTYPE.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_013_DOKTYPE_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_014_TIDIGARE_DOK.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_014_TIDIGAREDOKS_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_017_KOLLI.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_017_KOLLI_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_031_DEKLTYPE.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_031_DEKLTYPE_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_039_TILLAGSUPP.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_039_TILLAGSUPP_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_047_KONTROLL_RESULTAT.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_047_KONTROLL_RESULTAT_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_064_KANSLIGVARA.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_064_KANSLIGVARA_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_096_SPEC_OMST.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_096_SPEC_OMST_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_105_TILLGANGSKOD_GARANTI.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_105_TILLGANGASKOD_GARANTI_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_106_TULLKONTOR_REF.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_106_TULLKONTOR_REF_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
			
			}else if(CodeDropDownMgr.CODE_116_BETALNING_TRANSPORT.equalsIgnoreCase(paramTYP)){
				model.put(NctsImportConstants.RESOURCE_MODEL_KEY_CODE_NCTSEX_116_BETALNINGSSATT_TRANSPORTKOSTNAD_LIST, list);
				//model.put(NctsImportConstants.URL_EXTERNAL_TRANSPORT_SUMMARISKA_DOKUMENTCODES_40_SKAT_CODE, new UrlSkatTransportSummariskaDokumentObject() );
