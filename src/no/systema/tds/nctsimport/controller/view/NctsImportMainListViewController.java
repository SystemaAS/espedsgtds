...
@Controller
public class NctsImportMainListViewController {
	private static final Logger logger = Logger.getLogger(NctsImportMainListViewController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="tdsNctsImportMainListExcelView.do", method={RequestMethod.GET})
	public ModelAndView getItemListExcelView(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		...
		final String EXCEL_VIEW = "tdsNctsImportMainListExcelView";
