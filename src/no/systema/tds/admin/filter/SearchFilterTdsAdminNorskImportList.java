 ...
 * 
 */
package no.systema.tds.admin.filter;
 ...
 * @date 	Jan 14, 2014
 */
public class SearchFilterTdsAdminNorskImportList {
	private static final Logger logger = Logger.getLogger(SearchFilterTdsAdminNorskImportList.class.getName());
