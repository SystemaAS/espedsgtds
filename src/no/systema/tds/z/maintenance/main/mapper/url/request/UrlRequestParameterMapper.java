 ...
 * 
 */
package no.systema.tds.z.maintenance.main.mapper.url.request;
				...
				try{
					if(field!=null){
						...
						if(value==null){
							...
							sb.append(TdsMaintenanceConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + field.getName() + "=");
