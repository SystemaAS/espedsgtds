...
import no.systema.tvinn.sad.z.maintenance.nctsexport.model.JsonMaintNctsTransitKodeTypeRecord;
...
import no.systema.tvinn.sad.z.maintenance.sadexport.model.JsonMaintSadExportKodts6Record;
...
public class TvinnSadCodeDropDownMgr {
	private static final Logger logger = Logger.getLogger(TvinnSadCodeDropDownMgr.class.getName());
